...
--        2 => x"FFC29293",   -- subi x5, x5, -4  --  111111111100 00101 001 00101 0010011
        ...
        7 => x"FE0296E3", --     bne x5, x0, loop   1 [jump -20; note: assumes PC is incremented by 4]    --  1 111111 00000 00101 001 011 0 1 1100011
        8 => x"FFDFF06F", -- done: j done             [jump -4; note: assumes PC is incremented by 4]   --  1 1111111110 1 11111111 00000 1101111
        others => (others => '0')
    );
begin
    process(addr)
